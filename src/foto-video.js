...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.side-bar-news, .popular-news, .popular-item-sidebar, .side-bar-item, .news-image-sidebar,.news-card, .news-image, .container-more, .news-image-more').forEach((item, index) => {
        setTimeout(() => {
